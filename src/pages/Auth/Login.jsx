...
export default function Login() {
  ...
  // Icône SVG officielle de Google
  const GoogleIcon = () => (
        ...
        <div className="w-full max-w-[32rem]">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#f4f6f8] text-[#94a3b8]">ou continuer avec</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-4 px-4 bg-white border border-[#e2e8f0] rounded-xl hover:bg-[#f8fafc] hover:border-[#cbd5e1] transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
              ...
              <>
                <GoogleIcon />
                <span className="text-base font-medium text-[#334155]">Connexion avec Google</span>
              </>
            )}
          </button>
